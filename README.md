Родительский репозиторий для автоматизации запуска приложения TelegramAudioMessages

Приложение предназначено для озвучки сообщений из публичных групп.
...
- git clone https://github.com/lashnag/telegram-audio-messages.git
